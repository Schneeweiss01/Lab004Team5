     ...
     switch(ui8Direction)
      {
        ...
        case 1:
        {
          ...
          {
          ui8LeftWorkingSpeed = ui8LeftWorkingSpeed+ ACCELERATIONRATE+2;
          }
        ...
        case 4:
        {
          ...
          ledcWrite(1,0);
          ledcWrite(2,140);//ui8LeftWorkingSpeed);//previously 152
          ledcWrite(3,0);
          ledcWrite(4,130);//ui8RightWorkingSpeed);//previously 130
